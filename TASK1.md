...
1. Отображение объявления с лобовым стеклом на странице поиска автомобиля по фильтрам 
...
1. Отображение объявления автомобиля с неподходящим по фильтру “Год выпуска”
...
1. Некорректное отображение изображения в объявлении: сдвиг и обрезка
...
1. Отображение объявления автомобиля с неподходящим по фильтру “Привод”

**high:** Баг влияет на основной функционал фильтров поиска, что критично для пользователя.

1. Неверное расположение сноски "Соответствует оценке" за пределами области изображения в объявлении
...
1. Отображение объявления автомобиля с неподходящей по фильтру “Марка”

**high:**  Баг влияет на основной функционал фильтров поиска, что критично для пользователя.

1. Отображение объявлений автомобилей с неподходящим к запросу регионом
...
1. Некорректное местоположение товара в объявлении на странице поиска
...
1. Пропуск буквы в названии фильтра “Поколение” 

**low:** Ошибка в названии фильтра не влияет на его работу или функциональность. 

1. Некорректное написание даты в фильтре "Год выпуска”
...
1. Отсутствие надписи на кнопке на странице поиска
...
1. Отсутствие иконки для добавления товара в избранное в объявлении
